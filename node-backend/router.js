...
apiRouter.delete('/review/:id', userController.apiMustBeLoggedIn, reviewController.apiDelete)
apiRouter.delete('/post/:id', userController.apiMustBeLoggedIn, postController.apiDelete)
apiRouter.get('/review/:id', reviewController.reactApiViewSingle)
apiRouter.post('/review/:id/edit', userController.apiMustBeLoggedIn, reviewController.apiUpdate)
apiRouter.post('/create-post', userController.apiMustBeLoggedIn, postController.apiCreate)
apiRouter.post('/create-review', userController.apiMustBeLoggedIn, reviewController.apiCreate)
...
apiRouter.get('/profile/:username/reviews', userController.ifUserExists, userController.apiGetReviewsByUsername)
